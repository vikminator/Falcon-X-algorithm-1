 ...
 */
 ...
 /* The following defines are related to flying authorizations from to French air administration. */
  ...
  /**************************************************************************************/
    ...
    #define LCD_TELEMETRY_STEP "01234579" // should contain a 0 to allow switching off.
  ...
  /********************************************************************/
    ...
    #define VBATSCALE       128.6 // (*) (**) change this value if readed Battery voltage is different than real voltage
